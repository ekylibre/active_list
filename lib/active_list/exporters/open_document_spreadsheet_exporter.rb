  ...
  module Exporters
    class OpenDocumentSpreadsheetExporter < AbstractExporter
      ...
      def send_data_code
        ...
        code << "  zile << '#{mime_type.to_s}'\n"

        # Manifest
        code << "  zile.put_next_entry('META-INF/manifest.xml')\n"
        code << "  zile << ('<?xml version=\"1.0\" encoding=\"UTF-8\"?><manifest:manifest xmlns:manifest=\"urn:oasis:names:tc:opendocument:xmlns:manifest:1.0\"><manifest:file-entry manifest:media-type=\"#{mime_type.to_s}\" manifest:full-path=\"/\"/><manifest:file-entry manifest:media-type=\"text/xml\" manifest:full-path=\"content.xml\"/></manifest:manifest>')\n"
